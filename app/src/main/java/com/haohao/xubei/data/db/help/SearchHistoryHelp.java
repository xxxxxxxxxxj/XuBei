...
import com.haohao.xubei.data.db.gen.SearchHistoryTableDao;
...
public class SearchHistoryHelp {
     ...
     */
    public void saveSearchToDB(String userId, String type, String saveStr) {
     ...
     * 清理对应用户对应类型的所有历史数据库
     */
    public void deleteAllSearchDB(String userId, String type) {
     ...
     */
    public void deleteAllSearchDB(String userId, String type, String deleteStr) {
        List<SearchHistoryTable> historyTableList = mSearchHistoryTableDao.queryBuilder()
     ...
     * @param type   记录的类型（区分不同的使用地方）
     */
    public List<SearchHistoryTable> querySearchDB(String userId, String type) {
