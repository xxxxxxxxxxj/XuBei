...
public class LottieHeader extends InternalAbstract implements RefreshHeader {
    ...
    //默认的动画
    private String animationJson = "loading.json";
    ...
    protected LottieHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        rootLayout.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, SizeUtils.dp2px(LayoutDPH)));
